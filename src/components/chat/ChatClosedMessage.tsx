      ...
      <div className="flex flex-col gap-2 w-full max-w-[200px]">
        {!isTimeout && (
          <button
            ...
            className="w-full py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-xl transition-colors"
          >
        ...
        <button
          onClick={onClose}
          className="w-full py-2 text-sm font-medium text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-xl transition-colors"
        >
          {t('chat.close')}
        </button>
      </div>
