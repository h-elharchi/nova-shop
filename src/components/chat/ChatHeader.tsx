...
export function ChatHeader({ onClose, onMinimize, statusDot = 'green' }: ChatHeaderProps) {
  ...
  return (
    <div className="flex items-center justify-between px-4 py-3 bg-blue-600 dark:bg-blue-700 rounded-t-2xl">
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          className="p-1.5 rounded-lg text-blue-100 hover:bg-blue-500 dark:hover:bg-blue-600 transition-colors"
        >
